...
def destruct():
    ...
    pub1.publish(twist)
    pub2.publish(value)
rospy.init_node("swarm_bot_2_node")
pub1 = rospy.Publisher("/bot_2/cmd_vel", Twist, queue_size=10)
pub2 = rospy.Publisher("/bot_2/bot_2_controller/command", Float64, queue_size=10)
rate = rospy.Rate(1)
value = Float64()
twist = Twist()
try:
