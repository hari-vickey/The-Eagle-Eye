...
if __name__ == '__main__':
    ...
    rospy.loginfo("Spawning package")

    pack1 = create_cube_request(sdf_cube, "package1",
                              -0.70, -0.22, 0.1575,  # position
                              0.0, -1.05, 0.0,  # rotation
                              0.02, 0.02, 0.02)  # size
    spawn_srv.call(pack1)

    pack2 = create_cube_request(sdf_cube, "package2",
                              -0.70, -0.07, 0.1575,  # position
                              0.0, -1.05, 0.0,  # rotation
                              0.02, 0.02, 0.02)  # size
    spawn_srv.call(pack2)

    pack3 = create_cube_request(sdf_cube, "package3",
                              -0.70, 0.08, 0.1575,  # position
                              0.0, -1.05, 0.0,  # rotation
                              0.02, 0.02, 0.02)  # size
    spawn_srv.call(pack3)

    pack4 = create_cube_request(sdf_cube, "package4",
                              -0.70, 0.24, 0.1575,  # position
                              0.0, -1.05, 0.0,  # rotation
                              0.02, 0.02, 0.02)  # size
    spawn_srv.call(pack4)
