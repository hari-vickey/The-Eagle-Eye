...
ROS Publisher - bot2/control_signal
              - /data_visualize
"""
...
class Bot2():
    ...
    def __init__(self):
        ...
        rospy.loginfo("Started Bot2 Action Server.")
    ...
    def process_goal(self, start, goal, indsn, city, pkgid):
        ...
        try:
            ...
            if self.reverse == True:
                shipment = "Yes"
            self.flag = 1
            value = {'bot2': [start, goal, self.path, str(indsn), city, pkgid, dispatch, shipment]}
...
def main():
    ...
    # Creating Object for the Class Bot2
    bot2 = Bot2()
