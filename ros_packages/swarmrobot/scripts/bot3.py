...
Action Server - /action_bot3
ROS Publisher - bot3/control_signal
              - /data_visualize
"""
...
class Bot3():
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher("bot3/control_signal", Int16MultiArray, 
                                   queue_size=1)
        ...
        rospy.loginfo("Started Bot3 Action Server.")
    ...
    def process_goal(self, start, goal, indsn, city, pkgid):
        ...
        try:
            ...
            if self.reverse == True:
                shipment = "Yes"
            self.flag = 1
            value = {'bot3': [start, goal, self.path, str(indsn), city, pkgid, dispatch, shipment]}
...
def main():
    ...
    rospy.init_node('node_bot_3', anonymous=True)

    # Creating Object for the Class Bot3
    bot3 = Bot3()
